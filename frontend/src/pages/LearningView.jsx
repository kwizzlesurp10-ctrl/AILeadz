    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
      ...
      >
        <div className="min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Learning & Knowledge</h1>
          <p className="text-gray-500 mt-1 text-sm sm:text-base">Agent's accumulated knowledge and insights</p>
        </div>
        <div className="flex items-center space-x-4 shrink-0">
          <div className="bg-white rounded-xl px-4 py-2.5 sm:px-6 sm:py-3 shadow-sm border border-gray-200">
            <p className="text-xs sm:text-sm text-gray-500">Learning Entries</p>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white shadow-lg"
      >
